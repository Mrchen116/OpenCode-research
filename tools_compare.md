...
| Todo / Task Tracking | `TodoWrite` | opencode: `todowrite`, `todoread`<br>omo: `task` (task CRUD) |
| Terminal / System | `Bash` | opencode: `bash`, `list`<br>omo: `interactive_bash`, `look_at` |
| Agents / Delegation | `Task` | opencode: `task` (agent delegation)<br>omo: `delegate_task`, `call_omo_agent` |
